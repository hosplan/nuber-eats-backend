...
describe("UserService", () => {
  ...
  describe ("createAccount", () => {
    ...
    it('should fail on exceptiion', async() => {
  ...
  describe('login', () =>{
      ...
      it('should fail if ths password is wrong', async() => {
        const mockedUser = {
            id:1,
  ...
  describe('findById', () => {
      ...
      it('sould find and existing user', async() => {
        usersRepository.findOneOrFail.mockResolvedValue(findByIdArgs);
        const result = await service.findById(1);
        expect(result).toEqual({ok:true, user: findByIdArgs});
      });

      it('sould fail if no user is found', async() => {
  ...
  describe('editProfile', () => {
      ...
      it("should fail on exception", async() => {
          ...
          expect(result).toEqual({ok :false, error : 'fuck...'});
      });
  });  
